...
final List<HikingRoute> _sampleRoutes = [
  const HikingRoute(
    ...
    tags: ['亲子', '新手', '红叶', '有缆车'],
    waypoints: [
      Waypoint(id: '1-1', name: '东门', type: 'start', latitude: 39.9042, longitude: 116.4074, elevation: 150),
      Waypoint(id: '1-2', name: '香山寺', type: 'landmark', latitude: 39.9100, longitude: 116.4100, elevation: 220),
      Waypoint(id: '1-3', name: '山顶', type: 'end', latitude: 39.9150, longitude: 116.4080, elevation: 300),
    ],
    warnings: [],
    bestSeasons: ['春季', '秋季'],
    rating: 4.5,
  ...
  const HikingRoute(
    ...
    tags: ['经典', '有一定难度', '红叶'],
    waypoints: [
      Waypoint(id: '2-1', name: '东门', type: 'start', latitude: 39.9042, longitude: 116.4074, elevation: 100),
      Waypoint(id: '2-2', name: '香山寺', type: 'landmark', latitude: 39.9100, longitude: 116.4100, elevation: 250),
      Waypoint(id: '2-3', name: '鬼笑石', type: 'viewpoint', latitude: 39.9130, longitude: 116.4090, elevation: 450),
      Waypoint(id: '2-4', name: '香炉峰', type: 'end', latitude: 39.9150, longitude: 116.4080, elevation: 550),
    ],
  ...
  const HikingRoute(
    ...
    tags: ['新手进阶', '周末锻炼', '人少景美'],
    waypoints: [
      Waypoint(id: '3-1', name: '山脚', type: 'start', latitude: 39.9300, longitude: 116.3200, elevation: 50),
      Waypoint(id: '3-2', name: '望京楼', type: 'viewpoint', latitude: 39.9350, longitude: 116.3150, elevation: 300),
      Waypoint(id: '3-3', name: '山顶', type: 'end', latitude: 39.9400, longitude: 116.3100, elevation: 400),
    ],
    warnings: [],
  ...
  const HikingRoute(
    ...
    tags: ['挑战', '攀爬', '奇峰怪石'],
    waypoints: [
      Waypoint(id: '4-1', name: '景区入口', type: 'start', latitude: 40.0500, longitude: 116.0800, elevation: 150),
      Waypoint(id: '4-2', name: '天梯', type: 'danger', latitude: 40.0550, longitude: 116.0850, elevation: 400),
      Waypoint(id: '4-3', name: '飞来石', type: 'landmark', latitude: 40.0600, longitude: 116.0900, elevation: 600),
      Waypoint(id: '4-4', name: '北线山顶', type: 'end', latitude: 40.0650, longitude: 116.0950, elevation: 750),
    ],
  ...
  const HikingRoute(
    ...
    tags: ['历史', '朝圣', '古道', '有一定危险'],
    waypoints: [
      Waypoint(id: '5-1', name: '涧沟村', type: 'start', latitude: 40.0200, longitude: 116.0500, elevation: 300),
      Waypoint(id: '5-2', name: '玫瑰谷', type: 'rest_area', latitude: 40.0300, longitude: 116.0550, elevation: 600),
      Waypoint(id: '5-3', name: '妙顶峰', type: 'end', latitude: 40.0400, longitude: 116.0600, elevation: 1200),
    ],
  ...
  const HikingRoute(
    ...
    tags: ['穿越', '原始森林', '挑战极限'],
    waypoints: [
      Waypoint(id: '6-1', name: '北门', type: 'start', latitude: 40.6000, longitude: 117.5000, elevation: 600),
      Waypoint(id: '6-2', name: '清凉界', type: 'rest_area', latitude: 40.6200, longitude: 117.5200, elevation: 1000),
      Waypoint(id: '6-3', name: '曹官营', type: 'rest_area', latitude: 40.6400, longitude: 117.5400, elevation: 1400),
      Waypoint(id: '6-4', name: '主峰', type: 'end', latitude: 40.6500, longitude: 117.5600, elevation: 1800),
    ],
  ...
  const HikingRoute(
    ...
    tags: ['长城', '历史', '有一定难度'],
    waypoints: [
      Waypoint(id: '7-1', name: '景区入口', type: 'start', latitude: 40.4500, longitude: 116.5500, elevation: 200),
      Waypoint(id: '7-2', name: '正关台', type: 'landmark', latitude: 40.4600, longitude: 116.5600, elevation: 400),
      Waypoint(id: '7-3', name: '烽火台', type: 'end', latitude: 40.4700, longitude: 116.5700, elevation: 600),
    ],
  ...
  const HikingRoute(
    ...
    tags: ['亲子', '玩水', '避暑', '新手'],
    waypoints: [
      Waypoint(id: '8-1', name: '景区入口', type: 'start', latitude: 40.1000, longitude: 116.2000, elevation: 100),
      Waypoint(id: '8-2', name: '瀑布', type: 'viewpoint', latitude: 40.1050, longitude: 116.2050, elevation: 150),
      Waypoint(id: '8-3', name: '山顶亭', type: 'end', latitude: 40.1100, longitude: 116.2100, elevation: 200),
    ],
    warnings: [],
    bestSeasons: ['夏季'],
    rating: 4.2,
